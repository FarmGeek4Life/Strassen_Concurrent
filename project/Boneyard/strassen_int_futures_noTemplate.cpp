  ...
  Matrix operator*(const Matrix matrixB) const
   {
	 ...
	 {
	    future<Matrix> t1 = async(launch::async, &Matrix::operator*, (a00 + a11), (b00 + b11));
	    future<Matrix> t2 = async(launch::async, &Matrix::operator*, (a10 + a11), (b00)      );
	    future<Matrix> t3 = async(launch::async, &Matrix::operator*,  a00       , (b01 - b11));
	    future<Matrix> t4 = async(launch::async, &Matrix::operator*,  a11       , (b10 - b00));
	    future<Matrix> t5 = async(launch::async, &Matrix::operator*, (a00 + a01), (b11)      );
	    future<Matrix> t6 = async(launch::async, &Matrix::operator*, (a10 - a00), (b00 + b01));
	    future<Matrix> t7 = async(launch::async, &Matrix::operator*, (a01 - a11), (b10 + b11));
